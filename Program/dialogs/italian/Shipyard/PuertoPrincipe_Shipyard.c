...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Mi sono ricreduto...","Non ho nulla di cui parlare al momento."),"Uh, dove se n'è andata la mia memoria...","Mh, beh...","Avanti...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
