...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Ho cambiato idea...","Non ho nulla di cui parlare al momento."),"Uff, dove è andata a finire la mia memoria...","Mm, beh...","Vai avanti...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
