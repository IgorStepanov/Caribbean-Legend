...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Nessuna domanda per ora...","Mi dispiace, non ho nulla da dire adesso..."),"Ancora una volta, mi dispiace...","Forse è davvero il momento di commerciare...","Mi dispiace, facciamo affari...",npchar,Dialog.CurrentNode);
			link.l1.go = "exit";
		break;
	}
