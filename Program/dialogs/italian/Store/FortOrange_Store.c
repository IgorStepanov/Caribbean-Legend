...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("Quali domande hai?","Come posso aiutarti?"),"Hai cercato di farmi una domanda non molto tempo fa mentre eri nel negozio...","Questa è la terza domanda oggi. Ho bisogno di fare affari, non di impegnarmi in conversazioni senza senso...","Altre domande? Che ne dici di fare un affare invece?","block",1,npchar,Dialog.CurrentNode);
