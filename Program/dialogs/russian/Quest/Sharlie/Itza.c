...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "urakan_4":
			...
			link.l1 = "Чёрт побери! Значит, ОН уже здесь... (понижая голос) Уракан, я знаю всё. Я знаю, что это ты отправил Ксатл Ча со Стражем Истины на поиски Ксочитэма и маски Кукулькана. Я знаю, что ты не хочешь перемен, которые несёт с собой пришествие Кукулькана...";
			link.l1.go = "urakan_5";
		break;
