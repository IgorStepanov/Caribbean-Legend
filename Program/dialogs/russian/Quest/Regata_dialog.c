void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Regata_SiegeSkiper_1":
			...
			link.l1 = "Мне известно, что вы опытный штурман и хорошо знаете воды между Барбадосом и Кюрасао. Также мне известно, что вам нужно в Порт-Рояль. Я - участник регаты, мне предстоит последний переход как раз до Порт-Ройяла, и я хочу попросить вас войти в мою команду в качестве штурмана и лоцмана на этот переход.";
