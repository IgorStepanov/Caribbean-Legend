...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "OS_Tavern2_1":
			...
			link.l1 = "Да ну? Ничего странного? А как насчёт матроса с 'Морской Бестии', который в тот день приставал к тебе? Он, похоже, думал, что ты не против провести с ним ночь.";
		...
		case "OS_Tavern2_4_HO":
			dialog.text = "Я... я... расскажу вам всё! Это всё мой... кавалер, Джек. Джек Вейлс! Он подговорил меня, чтобы я соблазнила любого матроса из 'Морской Бестии'. И когда тот проявит наглость, я должна была поднять бучу, чтобы выманить хозяина таверны из-за стойки. Когда страсти начали утихать, два матроса начали бы драку, чтобы задержать его в зале. Так всё и произошло\nЗа это время капитан 'Морской Бестии' успел украсть бочонок. Это... это всё, что мне известно, "+GetSexPhrase("господин","госпожа")+"! Пожалуйста, не выдавайте меня! Я ведь... я ведь всего лишь... я просто... хотела, чтобы Джек наконец-то начал относиться ко мне с уважением! Я ведь помогла ему...";
