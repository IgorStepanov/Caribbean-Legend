...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "OS_Tavern1_4":
			dialog.text = "Да собственно никто! Разве что моя официантка, но это исключено. В тот день в таверне был небывалый кутёж - команда 'Морского Волка' вернулась с охоты, да ещё и с приличной добычей. У неё и минуты присесть не было, не говоря уже о том, чтобы  за стойкой шастать.";
		...
		case "OS_Tavern3_1":
			...
			link.l1 = "Это была тщательно продуманная махинация некоего Джека Вейлса на пару с капитаном 'Морского Волка'. Они привлекли своих матросов и разыграли настоящий спектакль, чтобы отвлечь вас. Когда вы покинули стойку, бочонок остался без присмотра - и они без труда его украли.";
