...
*/	
	...
	Locations[n].reload.l2.go = "KhaelRoa_Temple_h";
	Locations[n].reload.l2.emerge = "reload1";
	Locations[n].reload.l2.autoreload = "1";

	Locations[n].reload.l3.name = "reload1_back";
	Locations[n].reload.l3.go = "KhaelRoa_Temple_h";
	...
	// -------------------------------------------------
	Locations[n].id = "KhaelRoa_Temple_h";
	...
	Locations[n].reload.l2.go = "KhaelRoa_Labirint_1";
	...
	// -------------------------------------------------
	Locations[n].id = "KhaelRoa_Labirint_1";
	...
	// -------------------------------------------------
	Locations[n].id = "KhaelRoa_Labirint_2";
	Locations[n].filespath.models = "locations\Incas Temple\Labirint\";
	//Sound
		Locations[n].image = "loading\outside\TempleInside.tga";
	locations[n].type = "teno_inside";
	...
	// -------------------------------------------------
	Locations[n].id = "KhaelRoa_Labirint_3";
	Locations[n].filespath.models = "locations\Incas Temple\Labirint\";
	//Sound
	Locations[n].image = "loading\outside\TempleInside.tga";
	locations[n].type = "teno_inside";
	...
	Locations[n].reload.l24.go = "KhaelRoa_Labirint_1";
	...
	Locations[n].reload.l25.go = "KhaelRoa_Labirint_1";
	...
	Locations[n].reload.l26.go = "KhaelRoa_Labirint_1";
	...
	Locations[n].reload.l27.go = "KhaelRoa_Labirint_1";
	...
	// -------------------------------------------------
	Locations[n].id = "KhaelRoa_Treasure_Alcove";
	...
	//Reload map
	Locations[n].reload.l2.name = "reload1";
	Locations[n].reload.l2.go = "KhaelRoa_Labirint_3";
