...
#define GOOD_CANNON_36   	42  // FLAG_GOODS_CROWN_CANNONS
#define GOOD_CANNON_42   	43  // FLAG_GOODS_CROWN_CANNONS

#define GOOD_CULVERINE_8  	44
#define GOOD_CULVERINE_18 	45
#define GOOD_CULVERINE_36 	46  // FLAG_GOODS_CROWN_CANNONS

#define GOOD_CANNON_48 	    47  // FLAG_GOODS_CROWN_CANNONS
